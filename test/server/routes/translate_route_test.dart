    ...
    group('get and list', () {
      ...
      test('list glossaries', () {
        return addTestGlossary().then((uuid) async {
          ...
          expect(response.statusCode, 200);
          expect(data['data'].length, 1);
          expect(data['data'][0]['term'], 'Creeper');
          expect(data['data'][0]['translation'], '苦力怕');
          expect(data['data'][0]['description'], 'This is a Creeper');
          expect(data['data'][0]['language'], 'zh-TW');
          expect(data['data'][0]['modUUID'], null);
